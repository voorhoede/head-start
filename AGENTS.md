...
| `frontend-design` | [`.agents/skills/frontend-design/SKILL.md`](./.agents/skills/frontend-design/SKILL.md) | Building or styling UI components and pages — follows project aesthetics over generic AI defaults. |
