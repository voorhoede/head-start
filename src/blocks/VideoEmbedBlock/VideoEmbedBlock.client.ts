...
class VideoEmbed extends HTMLElement {
  ...
  constructor() {
    ...
    this.#consentButton = this.querySelector('[role="alert"] button') as HTMLButtonElement;
  ...
  connectedCallback() {
    if (!this.#consentAlert || !this.#consentButton || !this.#anchor || !this.#iframe || !this.#provider || !this.#videoUrl) {
    ...
    this.#consentButton.addEventListener('click', this.#consentAndPlay.bind(this));
  ...
  disconnectedCallback() {
    ...
    this.#consentButton.removeEventListener('click', this.#consentAndPlay.bind(this));
  }
